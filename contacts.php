...
<body>
          ...
          <?php
          	if(isset($_SESSION["USERNAME"])){
	            ...
	            if($_SESSION["PERAN"]==3){
	              ...
	              echo'<li><a href="welcomepage.php">Home</a></li>';
	        }
          ?>	
	...
	<div class="row" style="margin-top:70px;">
		<div class="text-persediaan"><p>Contacts</p></div>
		<div class="porto-item">
            <div class="col-md-3 portfolio-item">
                <a href="#">
                    <center><img class="img-responsive" src="images/ariq.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Ariq Naufal Kamil</a>
                </h3>
                <p>Phone Number : +628-5296267736</p>
            </div>
			 <div class="col-md-3 portfolio-item">
                <a href="#">
                   <center><img class="img-responsive" src="images/denny.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Denny Syahputra</a>
                </h3>
                <p>Phone Number : +628-2237210688</p>
            </div>
            <div class="col-md-3 portfolio-item">
                <a href="#">
                   <center><img class="img-responsive" src="images/maksal.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Maksalmina</a>
                </h3>
                <p>Phone Number : +628-2242505463</p>
            </div>
			  <div class="col-md-3 portfolio-item">
                <a href="#">
                    <center><img class="img-responsive" src="images/ari.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Abdul Ghiffari</a>
                </h3>
                <p>Phone Number : +628-5360095764</p>
            </div>
			 <div class="col-md-3 portfolio-item">
                <a href="#">
                    <center><img class="img-responsive" src="images/rahmat.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Rahmat Hidayat</a>
                </h3>
                <p>Phone Number : +628-2185874603</p>
            </div>
			 <div class="col-md-3 portfolio-item">
                <a href="#">
                   <center><img class="img-responsive" src="images/zul.jpg" alt=""></center>
                </a>
                <h3>
                    <a href="#">Zulikram Zainuddin</a>
                </h3>
                <p>Phone Number : +628-2273303457</p>
            </div>
		</div>	
        </div>
    </div>
