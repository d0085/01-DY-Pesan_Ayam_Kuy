...
<body>
	...
	<?php
		...
		echo'<div class="row" style=" margin:0;margin-top: -20px;">
			...
			<p class="text-center" style="font-size:23px; border-radius:4px">Confirm Pembelian</p>
			<br>
		<div class="text">	 
		<p class="text-center" style="font-size:20px; border-radius:4px">Jumlah Pesanan : '.$jml_permintaan.'</p>
		<br>
	
		<p class="text-center" style="font-size:20px; border-radius:4px">Total Harga : '.$harga.'</p>
		<br>
		...
		<center>
		<a href="proses_beli.php?chicken='.$jml_permintaan.'&harga='.$harga.'&pilih='.$acc_id.'
		" ><btn-primary class="btn btn-submit" style="font-size:18px;margin:10px 10px">Confirm</btn-primary></a>
		<a href="beli_ayam.php"><btn-primary class="btn btn-submit" style="font-size:18px;margin:10px 10px">Batal</btn-primary></a>
		</center>
