...
<head>
	...
	<title>Pemasok | Tambah Stok</title>
</head>
<body>
...
<?php
	...
	<div class="row" style="margin:0" >
			...
			<form class="pull-right login-form" style="margin-top:150px; width:550px; margin-right:400px;" action="proses_edit.php" method="post">
				<fieldset>
					<legend style="font-size:25px ; font-weight:bold">Tambah Stok</legend>
						Nama:<br>
						<input style="height:35px ; width:200px" type="text" value="'.$row['username'].'" name="username" disabled/><br>
						Jumlah:<br>
						<input style="height:30px ; width:200px" type="number" value="" name="js" required/><br><br>
							<div class="bawah">
								<table>
									<td><a href="cekstok.php"><button>Kembali</button></a><td>
